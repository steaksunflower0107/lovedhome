...
import (
	...
	getArea "home_rent/web/proto/getArea/proto/getArea"
	getImg "home_rent/web/proto/getImg/proto/getImg"
	houseMicro "home_rent/web/proto/house/proto/house"
	orderMicro "home_rent/web/proto/order/proto/userOrder"
	register "home_rent/web/proto/register/proto/register"
	user "home_rent/web/proto/user/proto/user"
	"home_rent/web/utils"
	"image/png"
	"net/http"
	"path"
